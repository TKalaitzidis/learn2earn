...
function ToC() {
  return (
    <div className="border bg-gray-50 overflow-y-auto max-h-80">
      <div className="flex justify-center items-center pt-24 pb-14 mx-24">
      <div>
        <p className="text-center pb-20">
          <strong >Terms and Conditions</strong>
        </p>
        <p>Our Terms and Conditions were last updated on 26/08/24.</p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>"Website"</strong> refers to Learn2Earn,
              accessible from https://www.learn2earn.com (Not a real URL as site is not and will not be live.)
            </p>
          </li>
          <li>
            <p>
